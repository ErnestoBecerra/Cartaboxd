...
<body>
	<div class="container">
		...
		<form:form action="/registrar-admin" method="POST" modelAttribute="administrador" class="row g-3">
			<div class="col-12">
			...
			<div class="col-12">
				...
				<form:input path="apellido" class="form-control" placeholder="Ingrese sus apellidos"/>
			...
			<div class="col-12">
    			<input type="submit" value="Agregar Administrador" class="btn btn-success mt-3">
  			</div>
